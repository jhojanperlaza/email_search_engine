    ...
    <nav class="bg-black py-2">
        <div class="max-w-7xl mx-auto">
            <div class="flex justify-between items-center">
                ...
                <!--logo-->
                <div>
                    <img src="./images/logo.png" alt="logo" class="w-64 h-auto">
                </div>
                ...
                <div class="hidden md:flex space-x-4">
                    <a href="https://www.linkedin.com/in/jhojan-p-a45b1813a/">
                        <img src="./icons/linkedin.png" alt="linkedin-icon" class="w-14 h-14">
                    </a>
                    <a href="https://github.com/jhojanperlaza">
                        <img src="./icons/github.png" alt="linkedin-icon" class="w-14 h-14">
                    </a>
                </div>
